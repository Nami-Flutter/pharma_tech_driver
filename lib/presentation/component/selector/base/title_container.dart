...
class TitleContainer extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
    ...
    renderObject.titleColor = titleColor ?? Theme.of(context).primaryColor;
    renderObject.backgroundColor = backgroundColor ?? Theme.of(context).cardColor;
...
class RenderTitledContainer extends RenderBox
  ...
  void paint(PaintingContext context, Offset offset) {
    if (child != null) {
      ...
      title != null ? textPainter.paint(canvas, titleOffset) : null;
