...
class CustomSettingCared extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<LoginLogoutViewModel>(context, listen: true)
    ...
    return Column(
      ...
      children: [
        ...
        //         height: 96.h,
        //         width: 96.w,
        //         child:(getUserId.getUserData()?.data?.delegate?.id !=null)? CachedNetworkImage(
        //         fit: BoxFit.fill,
        ...
        //   ],
        // ),
        label((getUserId.getUserData()?.data?.delegate?.id !=null)?'${provider?.name ?? ''} ':LocaleKeys.pharmaTech.tr()),
      ],
    );
  }
